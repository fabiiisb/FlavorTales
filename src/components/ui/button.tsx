...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-2xl text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-forest-500 hover:bg-forest-600 text-white",
        destructive:
          "bg-sunsetOrange-500 text-white hover:bg-sunsetOrange-600",
        outline:
          "border border-forest-500 text-forest-500 hover:bg-forest-100",
        outlined_Destructive:
          "border border-sunsetOrange-500 text-sunsetOrange-500 hover:bg-sunsetOrange-500/40 hover:text-white",
        secondary:
